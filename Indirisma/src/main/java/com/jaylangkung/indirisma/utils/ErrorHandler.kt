...
import com.jaylangkung.indirisma.utils.room.Logger
import com.jaylangkung.indirisma.utils.room.LoggerDatabase
    ...
    fun responseHandler(context: Context, func: String, message: String) {
        ...
        when {
            ...
            message.contains("Internal Server Error", ignoreCase = true) -> {
                Toasty.error(context, "Terdapat permasalahan pada database", Toasty.LENGTH_LONG).show()
            }
            else -> {
