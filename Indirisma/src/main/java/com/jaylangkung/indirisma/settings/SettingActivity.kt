...
import com.jaylangkung.indirisma.BuildConfig
...
import com.jaylangkung.indirisma.databinding.ActivitySettingBinding
...
import com.jaylangkung.indirisma.utils.room.LoggerActivity
...
class SettingActivity : AppCompatActivity() {
    ...
    private fun logout(idadmin: String) {
        ...
        service.logout(idadmin, "true").enqueue(object : Callback<DefaultResponse> {
