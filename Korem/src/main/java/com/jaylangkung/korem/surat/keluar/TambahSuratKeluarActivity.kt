...
import com.jaylangkung.korem.databinding.ActivityTambahSuratKeluarBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            for (i in 0 until MainActivity2.listUserSurat.size) {
                listUser.add(MainActivity2.listUserSurat[i].nama)
            }
            ...
            penerimaSpinner.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
                override fun onItemSelected(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) {
                    idPenerima = MainActivity2.listUserSurat[p2].idsurat_user_aktivasi
                }
